      ...
      <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" style="max-width:600px; width:100%; border-collapse:collapse; background-color:#ffffff; background-image:linear-gradient(#ffffff,#ffffff);">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;">
              <tr>
                ...
                <td align="right" style="vertical-align:middle;">
                  <p style="font-size:14px; font-weight:600; color:#fffffe; margin:0; font-family:system-ui,Arial,sans-serif;">
                    <span class="gmail-difference"><span class="gmail-screen" style="color:#fffffe !important; -webkit-text-fill-color:#fffffe !important; text-decoration:none;">FlyFDX.com</span></span>
                  </p>
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td style="padding:0; line-height:0; font-size:0;">
            <img src="https://lh3.googleusercontent.com/aida/ADBb0uhSQwIqrf_AKiRfV_F-6gtfCzyqTIM5X5EbfoWMM636-JQWbktWYftlWHqU2cGRLu_Nk1eR7mfop4QTnOxlX-yoEPi2Ypas1uOhvtL4JIFDtnJ2hlFilLePqElE_ieXFz9OQKY39PNimKBu-OiUOuwqZroZ1vlKLfaPX1vGk_nEby4QU8A007Ub0_fCvUH2x39ryVoDHDo2np7SRm0ELyFsUN4bW6VThQT0UrGkZTf6QQM0_l1hFu2zwjNwZmM-qJTumIWyni1Z" alt="FedEx aircraft" width="600" style="max-width:100%; display:block; width:100%; height:auto;">
          </td>
        </tr>
