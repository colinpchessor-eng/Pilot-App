                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; margin:0 0 16px;">
                    <tr>
                      <td class="email-legacy-box" style="background-color:#f3f3f3; border:1px solid #cdc3d4; border-radius:12px; padding:24px 20px; text-align:center;">
                        ...
                        <p class="email-purple-dark" style="font-size:32px; font-weight:700; color:#1a1d24; letter-spacing:0.2em; padding:8px 0; margin:0; font-family:'Courier New',Courier,monospace;">${candidateId}</p>
                      </td>
                    </tr>
                  </table>

                  <p class="email-purple-dark" style="font-size:20px; font-weight:600; color:#1a1d24; line-height:28px; margin:0 0 16px; font-family:system-ui,Arial,sans-serif;">Next Steps</p>
                    ...
                    <tr>
                      <td style="padding:14px 16px;">
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                          <tr>
                            <td valign="top" style="padding-right:14px;">
                              <div style="background-color:#1a1d24; color:#ffffff; width:30px; height:30px; border-radius:50%; font-size:13px; font-weight:700; text-align:center; line-height:30px; min-width:30px; font-family:system-ui,Arial,sans-serif;">3</div>
                            </td>
                            <td valign="top" class="email-body-dark" style="padding-top:5px; font-size:14px; line-height:20px; color:#1a1c1c; font-family:system-ui,Arial,sans-serif;">Enter your Legacy ID <strong class="email-purple-dark" style="font-family:'Courier New',Courier,monospace; letter-spacing:0.1em; color:#1a1d24;">${candidateId}</strong> when prompted to link your portal account</td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style="padding:14px 16px;">
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                          <tr>
                            <td valign="top" style="padding-right:14px;">
                              <div style="background-color:#1a1d24; color:#ffffff; width:30px; height:30px; border-radius:50%; font-size:13px; font-weight:700; text-align:center; line-height:30px; min-width:30px; font-family:system-ui,Arial,sans-serif;">4</div>
                            </td>
