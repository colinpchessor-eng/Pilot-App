...
export const PIPELINE_STAGES: readonly {
  ...
  { id: 'testing', label: 'Testing', statuses: ['testing_invited', 'testing_scheduled'] },
  { id: 'interview', label: 'Interview', statuses: ['interview_sent', 'scheduled'] },
  {
    id: 'indoctrination',
    label: 'Indoctrination',
    statuses: ['indoctrination_invited', 'indoctrination_scheduled'],
  },
...
const FLOW_BADGES: Record<string, FlowBadgeSpec> = {
  ...
  testing_invited: { label: 'Testing invited', bg: '#E3F2FD', color: '#1565C0' },
  testing_scheduled: { label: 'Testing scheduled', bg: '#E8F5E9', color: '#2E7D32' },
  interview_sent: { label: 'Interview Sent', bg: '#E3F2FD', color: '#1565C0' },
  scheduled: { label: 'Scheduled', bg: '#E8F5E9', color: '#2E7D32' },
  indoctrination_invited: { label: 'Class invited', bg: '#FFF3E0', color: '#E65100' },
  indoctrination_scheduled: { label: 'Class scheduled', bg: '#E8F5E9', color: '#2E7D32' },
